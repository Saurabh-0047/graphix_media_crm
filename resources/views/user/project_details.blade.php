            ...
            <section class="content">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="box" style="background: azure;">
                            <div class="box-header with-border">
                                <h4 class="box-title">Modules Of <strong>{{ $project_details->business_name }}</strong>
                                </h4>
                            </div>
                                    ...
                                    <tbody>
                                        @foreach ($project_details->modules as $module)
                                            ...
                                            <tr style="background-color: {{ $backgroundColor }};">
                                                ...
                                                <td>
                                                    @if ($module->module_status == 'Pending')
                                                        <form action="{{ route('modules.accept', $module->id) }}"
                                                            method="POST" style="display: inline;">
                                                            @csrf
                                                            <button type="submit"
                                                                class="btn btn-primary">Accept</button>
                                                        </form>
                                                    @elseif ($module->module_status == 'Accepted')
                                                        <form action="{{ route('modules.complete', $module->id) }}"
                                                            method="POST" style="display: inline;">
                                                            @csrf
                                                            <button type="submit"
                                                                class="btn btn-success">Complete</button>
                                                        </form>
                                                        {{ $module->user ? $module->user->user_name : 'N/A' }}
                                                    @else
                                                        {{ $module->user ? $module->user->user_name : 'N/A' }}
                                                    @endif
                                                </td>
