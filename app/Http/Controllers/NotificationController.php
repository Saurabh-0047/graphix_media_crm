...
class NotificationController extends Controller
{
        ...
        $formattedNotifications = $notifications->map(function ($notification) {
            return [
                ...
                'date' => $notification->created_at,
                 'lead_id' => route('admin_project.details', ['id' => $notification->project_id]),
            ];
        });
    ...
    public function unreadCount_user()
    {
    ...
    public function markAllAsRead_user(Request $request)
    {
        // Validate the request
        $request->validate([
            'user_id' => 'required|string',
    ...
    public function getNotifications_user(){
        ...
        $formattedNotifications = $notifications->map(function ($notification) {
            return [
                ...
                'heading' => $notification->heading,
                'date' => $notification->created_at,
                 'lead_id' => route('user.project_details', ['id' => $notification->project_id]),
            ];
        });
